...
public class BoardTeamFileStoreTest extends BaseFileStoreTest {
    //
    private BoardTeamStore Store = new BoardTeamFileStore();
    ...
    public void setUp() {
        ...
        for (DCBoardMember boardMember : members) {
            Store.createMember("001", boardMember);
        }
    }
    ...
    public void testCreate() throws EmptyResultException {
        ...
        DCBoardTeam created = Store.retrieveByName("개발팀");
    ...
    public void testRetrieve() throws EmptyResultException {
        //
        DCBoardTeam created = Store.retrieve(this.teamUsid);
    ...
    public void testRetrieveByName() throws EmptyResultException {
        //
        DCBoardTeam saved = Store.retrieveByName("컨설팅팀");
    ...
    public void testRetrieveAll() {
        //
        List<DCBoardTeam> allTeams = Store.retrieveAll();
    ...
    public void testDelete() throws EmptyResultException {
        //
        DCBoardTeam saved = Store.retrieve(this.teamUsid);
        assertNotNull(saved);
        
        List<DCBoardMember> teamMembers = Store.retrieveMembers(this.teamUsid);
        assertFalse(teamMembers.isEmpty());
        
        
        Store.delete(this.teamUsid);
        
        try {
            Store.retrieve(this.teamUsid);
            fail("Didn't throw exception");
        } catch (EmptyResultException e) {}
        
        
        List<DCBoardMember> deletedMembers = Store.retrieveMembers(this.teamUsid);
    ...
    public void testCreateMember() throws EmptyResultException {
        //
        DCBoardTeam team = Store.retrieve(this.teamUsid);
        DCBoardUser user = userStore.retrieveByEmail("eschoi@nextree.co.kr");
        
        DCBoardMember member = new DCBoardMember(team, user);
        Store.createMember(team.getUsid(), member);
        
        DCBoardMember created = Store.retrieveMember(team.getUsid(), user.getEmail());
        assertNotNull(created);
    ...
    public void testRetrieveMember() throws EmptyResultException {
        //
        DCBoardMember member = Store.retrieveMember(this.teamUsid, "hkkang@nextree.co.kr");
    ...
    public void testRetrieveMembers() {
        //
        List<DCBoardMember> members = Store.retrieveMembers(this.teamUsid);
    ...
    public void testDeleteMember() {
        //
        Store.deleteMember(this.teamUsid, "hkkang@nextree.co.kr");
        
        try {
            Store.retrieveMember(this.teamUsid, "hkkang@nextree.co.kr");
            fail("Didn't throw exception");
        } catch (EmptyResultException e) {}
