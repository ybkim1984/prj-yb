...
<head>
    ...
    <script src="${ctx}/resources/board/board_create_ui.js"></script>
                	...
                	<form class="form-horizontal">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="input_boardName" name="boardName">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select name="teamUsid" class="form-control" id="input_teamUsid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <div class="checkbox">
                                        <label><input type="checkbox" name="commentable" id="input_commentable"> 댓글사용</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-10 col-lg-offset-2">
                                    <a class="btn btn-default" id="btn_save">확인</a>
                                    <a class="btn btn-primary" id="btn_cancel">취소</a>
                                </div>
                            </div>
