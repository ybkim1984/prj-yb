...
public class BoardUserServiceLogic implements BoardUserService {
    ...
    public void registerUser(DCBoardUser user) {
        // 
        if (!user.isValid()) {
            throw new NamooBoardException("Invalid DCBoardUser object."); 
        }
    ...
    public boolean loginAsUser(String userEmail, String password) {
        // 
        try {
            DCBoardUser user = userStore.retrieveByEmail(userEmail);
    ...
    public String registerBoardTeam(String teamName, String adminEmail) {
        ...
        try {
            DCBoardUser adminUser = userStore.retrieveByEmail(adminEmail); 
            DCBoardTeam team = new DCBoardTeam(teamName, adminUser); 
            ...
            DCBoardMember member = new DCBoardMember(team, adminUser); 
