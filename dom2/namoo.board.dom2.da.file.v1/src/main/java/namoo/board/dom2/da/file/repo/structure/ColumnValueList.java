...
public class ColumnValueList {
    ...
    public ColumnValueList(ColumnValue columnValue) {
        //
    ...
    public ColumnValue getIndexColumnValue() {
        //
    ...
    public byte[] getDataCsvBytes() {
        //
        return getDataCsvStr().getBytes(FileConst.FILE_ENCODING);
    }
    
    public String getDataCsv() {
        //
        return getDataCsvStr();
    }
    
    //--------------------------------------------------------------------------
    
    private String getDataCsvStr() {
        //
