    ...
    <div class="row">
            ...
            <div class="list-group panel panel-success">
                ...
                <div>
                    <c:forEach var="board" items="${boardList}">
                        <a href="${ctx}/board/${board.usid}/posts?=page1" class="list-group-item hidden-xs">${board.name}</a>
                    </c:forEach>
                </div>
        ...
        <div class="col-sm-9 col-lg-9">
            ...
            <div class="table-responsive">
                <div class="well">
                    <form class="bs-example form-horizontal" action="${ctx}/board/${boardUsid}/post/create" method="post">
                        <fieldset>
