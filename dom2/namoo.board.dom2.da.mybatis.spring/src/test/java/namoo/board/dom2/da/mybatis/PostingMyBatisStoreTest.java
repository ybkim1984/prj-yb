...
public class PostingMyBatisStoreTest extends BaseMyBatisStoreDbUnitTest {
    ...
    public void testUpdateContents() throws EmptyResultException {
        ...
        String contentsUpdateStr = "안녕하세요.";
        DCPostingContents updateContents = new DCPostingContents(posting, contentsUpdateStr);
        ...
        assertEquals(contentsUpdateStr, updatedContents.getContents());
    }
