...
CREATE TABLE IF NOT EXISTS board_team (
    ...
    admin_user_email     VARCHAR(50)     NOT NULL,
    reg_date        DATETIME        NOT NULL,        -- 조회는 하지 않는 데이터 입력일시 참고 목적
...
CREATE TABLE IF NOT EXISTS board_member (
    ...
    team_team_id    CHAR(3)         NOT NULL,
    user_user_email VARCHAR(50)     NOT NULL,
    reg_date        DATETIME        NOT NULL,        -- 조회는 하지 않는 데이터 입력일시 참고 목적
...
CREATE TABLE IF NOT EXISTS postingcontents
		posting_id							CHAR(8)					PRIMARY KEY,		
		contents								contents        VARCHAR(5000)		
);	
